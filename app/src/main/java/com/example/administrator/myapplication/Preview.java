...
/**
 * Created by shinjaehun on 2017. 4. 14..
 */
...
class Preview extends ViewGroup implements SurfaceHolder.Callback {
    ...
    Preview(Context context, SurfaceView sv ,double ratio) {
        super(context);
        this.ratio = ratio;
        mSurfaceView = sv;
    ...
    public void setCamera(Camera camera) {
        ...
        if (mCamera != null) {
            ...
            for(int i=0; i<mSupportedPreviewSizes.size(); i++) {
                ...
                double diffRatio = Math.abs((ratio - (width / height)));
                diffRatio = Math.round(diffRatio * 100000d) / 100000d;

                if (diffRatio < compareSize) {
                    compareSize = diffRatio;
                    index = i;
                }
